                ...
                <a href="" class="navbar-brand">
                    <span class="logo-box grey-bg">
                        ...
                        <img src="{{ $s_logo . (isset($store_settings['logo']) && !empty($store_settings['logo']) ? $store_settings['logo'] : 'logo.png') }}"
                            class="nav_tab_img" style="margin:15px 9px ">
                ...
                <ul class="navigation navigation main pro_category">
                    @foreach ($categories as $key => $category)
                        <li class="nav-item">
                            ...
                            <a data-href="{{ $loop->iteration }}{!! str_replace(' ', '_', $category) !!}"
                                class="{{ $key == 0 ? 'active' : '' }} custom-list-group-item text-link grey-text productTab">
                                {{ __($category) }}
                            </a>
            ...
            <nav class="navbar header-navbar navbar-expand floating-nav align-items-center">
                <div class="navbar-container d-flex align-items-center justify-content-between">
                    <a href="#" class="nav-brand nav-logo">
                        <img src="{{ asset(Storage::url('uploads/store_logo/') . (!empty($store->logo) ? $store->logo : 'logo.png')) }}"
                    ...
                    <div class="search-bar">
                        ...
                        @if (Utility::CustomerAuthCheck($store->slug) == true)
                            <div class="dropdown">
                                <button class="nav-link btn dropdown-toggle bg--gray text-white" type="button"
                                ...
                                <div class="dropdown-menu dropdown-menu-custom" aria-labelledby="dropdownMenuButton">
                                    ...
                                    @if (Utility::CustomerAuthCheck($store->slug) == false)
                                        <a class="dropdown-item"
                                            href="{{ route('customer.login', $store->slug) }}">{{ __('Sign in') }}</a>
                                    @else
                        ...
                        @else
                            <a data-url="{{ route('customer.login', $store->slug) }}" data-ajax-popup="true"
                                ...
                                class="btn text-white ml-1  float-right ml-2 bg--gray hover-translate-y-n3 icon-font"
            ...
            <div class="content-wrapper">
                <div class="content-body">
                    <div class="row match-height">
                                    ...
                                    <div class="right-area">
                                        ...
                                        <div class="filter-by">
                                            ...
                                            <div class="dropdown price-dropdown">
                                                <a class="px-0" href="#" role="button"
                                                    data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                                                    data-offset="0,10">
                                                    <span>{{ __('Price') }} <img
                                                            src="{{ asset('custom/images/select-arrow.png') }}"
                                                            alt="" /></span>
                                                </a>
                                                <div class="dropdown-menu dropdown-menu-sm" id="product_sort">
                                                    <a href="#" class="dropdown-item hightolow"
                                                        data-val="hightolow">{{ __('High To Low') }}</a>
                                                    <a href="#" class="dropdown-item lowtohigh"
                                                        data-val="lowtohigh"> {{ __('Low To High') }}</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-xl-4">
                            <div class="card">
                                <h5 class="card-header card-title coupon-title">{{ __('Coupon') }}</h5>
                                ...
                                <div class="card-body">
                                    <div class="form-group product-detail apply-stripe-btn-coupon">
                                        <a href="#"
                                            class="btn btn-addcart apply-coupon btn-sm">{{ __('Apply') }}</a>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        @if (count($shippings) != 0)
                                            <div class="card">
                                                <div class="form-group">
                                                    <h4 class="card-header card-title">{{ __('Shipping Location') }}
                                                    </h4>
                                                </div>
                                                <div class="card-body">
                            ...
                            <div class="card cart-card cart_dispay" id="card-summary">
                                <div class="card-header pb-3">
                                    <h4 class="card-title cart-title">{{ __('Cart') }}</h4>
                                </div>
                                @if (!empty($pro_cart) && count($pro_cart['products']) > 0)
                                    @php
                                        $sub_tax = 0;
                                                ...
                                                @if ($product['variant_id'] != 0)
                                                    ...
                                                    <div class="checkout-items">
                                                        <div class="customer-images">
                                                            ...
                                                            <img
                                                                src="{{ !empty($product['cover_image']) ? $logo . '/' . $product['cover_image'] : $logo . '/avatar.png' }}" /></span>
                                                                ...
                                                                <span class="detail-qty pr-1">
                                                                    <div data-id="{{ $key }}">
                                                                        <input type="text"
                                                                            ...
                                                                            data-id="{{ $product['id'] }}"
                                                                            class="bx-cart-qty qty form-control form-control-sm custom-bx-cart-qty text-center pr-0 pl-0 product_qty_input"
                                                        ...
                                                        <div class="item-spin" data-id="{{ $key }}">
                                                            <button class="spin-rupes product_qty"
                                                                data-id="{{ $product['id'] }}" type="submit"
                                                                value="{{ $product['quantity'] }}"
                                                                data-option="decrease">
                                                                <img src="{{ asset('custom/images/minus-icon.svg') }}"
                                                                    alt="#" width="15px">
                                                            </button>

                                                            <input type="hidden" class="pro_variant_id"
                                                                data-id="{{ $product['variant_id'] }}"
                                                                id="product_qty">
                                                            <p class="price-spin">
                                                                {{ \App\Models\Utility::priceFormat($product['variant_price'] * $product['quantity']) }}
                                                            </p>
                                                            ...
                                                            <button class="spin-rupes product_qty"
                                                                ...
                                                                <img src="{{ asset('custom/images/pluse-icon.svg') }}"
                                                                    alt="#" width="15px">
                                                            </button>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="checkout-items">
                                                                ...
                                                                <span class="detail-qty pr-1">
                                                                    <div data-id="{{ $key }}">
                                                                        <input type="text"
                                                                            value="{{ $product['quantity'] }}"
                                                                            data-id="{{ $product['id'] }}"
                                                                            class="bx-cart-qty qty form-control form-control-sm text-center custom-bx-cart-qty pr-0 pl-0 product_qty_input"
                                                                            id="product_qty_input"
                                                                            oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');">
                                                                    </div>
                                                                </span>
                                                        ...
                                                        <div class="item-spin" data-id="{{ $key }}">
                                                            ...
                                                            <input type="hidden" class="pro_variant_id"
                                                                ...
                                                                id="product_qty">
                                                            <p class="price-spin">
                                                                {{ \App\Models\Utility::priceFormat($product['price'] * $product['quantity']) }}
                                                            </p>
                                        ...
                                        <div class="invoice-details">
                                            <ul class="invoice-list">
                                                <li class="invoice-detail">
                                                    ...
                                                    <div class="invoice-amt font-weight600 sub_total_price"
                                                        data-value="{{ $total }}">
                                                ...
                                                @if (!empty($pro_cart) && count($pro_cart['products']) > 0)
                                                    <li class="invoice-detail">
                                                        ...
                                                        <div class="invoice-amt">
                                                            <span
                                                                class="invoice-amt font-weight-bold shipping_price">0.00</span>
                                                        </div>
                                                    </li>
                                                @endif
                                                @foreach ($taxArr['tax'] as $k => $tax)
                                                    <li class="invoice-detail">
                                                        ...
                                                        <div class="invoice-amt">
                                                            <span
                                                                class="invoice-amt font-weight-bold">{{ \App\Models\Utility::priceFormat($taxArr['rate'][$k]) }}</span>
                                                        </div>
                                                    </li>
                                                @endforeach
                                            ...
                                            <ul class="invoice-list">
                                                ...
                                                @if (!empty($pro_cart) && count($pro_cart['products']) > 0)
                                                    <li class="invoice-detail">
                                                        ...
                                                        <div class="invoice-amt">
                                                            <span
                                                                class="text-sm font-weight-bold shipping_price">0.00</span>
                                                        </div>
                                                    </li>
                                                @endif
                                                @if (!empty($taxArr))
                                                ...
                                                <li class="invoice-detail">
                                                    ...
                                                    <div class="invoice-amt total-amount pro_total_price"
                            ...
                            <div class="card delivery-card" id="">
                                ...
                                <div class="card-body detail-form" id="delivery_card">
                                    <div class="form-group">
                                        ...
                                        {{ Form::text('name', old('name'), ['class' => 'active acticard-titleve fname', 'required' => 'required']) }}
                                    </div>
                                    <div class="form-group">
                            ...
                            <div class="card instruction-card">
                                <div class="card-header">
                                    <h3 class="card-title cart-title order-notes">{{ __('Order Notes') }}</h3>
                                </div>
                                <div class="card-body">
                            ...
                            <div class="order-md-1 text-center fs-2">
                                @if (
                                    ...
                                    <a href="#"
                                        class="btn btn-white btn-white btn-icon rounded-pill hover-translate-y-n3 checkoutBtn mb-3"
                                        data-toggle="modal" data-target="#checkoutModal">
                                        <span
                                            class="btn-inner--text text-primary">{{ __('Proceed to checkout') }}</span>
                                        <i class="fas fa-shopping-basket"></i>
                                    </a>
                                @else
                                    <a href="#footer"
                                        class="btn btn-white btn-white btn-icon rounded-pill hover-translate-y-n3 checkoutBtn mb-3 authUser">
                                        <span
                                            class="btn-inner--text text-primary">{{ __('Proceed to checkout') }}</span>
                                        <i class="fas fa-shopping-basket"></i>
                                    </a>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="card whatsapp-card">
                                            <button type="submit" class="btn whatsap-btn payment"
                                                id="owner-whatsapp" data-toggle="modal" data-target="#checkoutModal">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="card telegram-card">
                                            <button type="submit" class="btn telegram-btn pt-2" id="owner-telegram">
                                                <img src="{{ asset('custom/images/telegram.svg') }}" alt="#"
                                                    width="50px">
                            ...
                            <div class="row justify-content-center" id="paymentsBtn">
                                @if (isset($store_payments['is_stripe_enabled']) && $store_payments['is_stripe_enabled'] == 'on')
                                    ...
                                    <div
                                        class="col-lg-4 col-md-4 col-sm-12 align-items-center justify-content-between ">
                                        <div class="card telegram-card pay_online_btn bg--gray border-0">
                                            <form role="form" action="{{ route('stripe.post', $store->slug) }}"
                                                ...
                                                <button type="submit" class="btn telegram-btn text-xs  pt-2"
                                                    width="50px" id="owner-stripe">
                                        ...
                                        <div class="card telegram-card pay_online_btn bg--gray border-0">
                                            <form method="POST"
                                                ...
                                                <input type="hidden" name="special_instruct"
                                                    class="customer_special_instruct">
                                                <input type="hidden" name="wts_number" class="customer_wts_number">
                                                <button type="submit" class="btn telegram-btn   pt-2"
                                                    id="owner-paypal" width="50px">
                                ...
                                @if (isset($store_payments['is_paystack_enabled']) && $store_payments['is_paystack_enabled'] == 'on')
                                    ...
                                    <div
                                        class="col-lg-4 col-md-4 col-sm-12 align-items-center justify-content-between ">
                                        <div class="card telegram-card pay_online_btn bg--gray border-0">
                                            <button type="button" onclick="payWithPaystack()" id="btnclick"
                                                class="btn telegram-btn  pt-2" width="50px">
                                                <i class="fas fa-credit-card"></i>
                                                {{ __('Pay via Paystack') }}
                                            </button>
                                        </div>
                                ...
                                @if (isset($store_payments['is_razorpay_enabled']) && $store_payments['is_razorpay_enabled'] == 'on')
                                    ...
                                    <div
                                        class="col-lg-4 col-md-4 col-sm-12 align-items-center justify-content-between ">
                                        <div class="card telegram-card pay_online_btn bg--gray border-0">
                                            <button type="button" onclick="payRazorPay()"
                                                class="btn telegram-btn  pt-2" width="50px">
                                                <i class="fas fa-credit-card"></i>
                                                {{ __('Pay via Razorpay') }}
                                            </button>
                                    ...
                                    <div
                                        ...
                                        <div class="card telegram-card pay_online_btn bg--gray border-0">
                                            <form id="payment-paytm-form" method="POST"
                                                ...
                                                @endphp
                                                <button type="submit" id="owner-paytm"
                                                    class="btn telegram-btn  pt-2" width="50px">
                                                    <i class="fas fa-credit-card"></i>
                                                    {{ __('Pay via Paytm') }}
                                                </button>
                                ...
                                @if (isset($store_payments['is_mercado_enabled']) && $store_payments['is_mercado_enabled'] == 'on')
                                    ...
                                    <div
                                        class="col-lg-4 col-md-4 col-sm-12 align-items-center justify-content-between ">
                                        <div class="card telegram-card pay_online_btn bg--gray border-0">
                                            <button type="button" onclick="payMercado()"
                                                class="btn telegram-btn  pt-2" width="50px">
                                                <i class="fas fa-credit-card"></i>
                                    ...
                                    <div
                                        ...
                                        <div class="card telegram-card pay_online_btn bg--gray border-0">
                                            <form id="payment-mollie-form" method="POST"
                                                ...
                                                <button type="submit" id="owner-mollie"
                                                    class="btn telegram-btn  pt-2" width="50px">
                                                    <i class="fas fa-credit-card"></i>
                                                    {{ __('Pay via Mollie') }}
                                                </button>
                                        ...
                                        <div class="card telegram-card pay_online_btn bg--gray border-0">
                                            <form id="payment-skrill-form" method="POST"
                                                ...
                                                <input type="hidden" name="special_instruct"
                                                    class="customer_special_instruct">
                                                <input type="hidden" name="wts_number" class="customer_wts_number">
                                                <button type="submit" id="owner-skrill"
                                                    class="btn telegram-btn  pt-2" width="50px">
                                                    <i class="fas fa-credit-card"></i>
                                                    {{ __('Pay via Skrill') }}
                                                </button>
                                        ...
                                        <div class="card telegram-card pay_online_btn bg--gray border-0">
                                            <form id="payment-coingate-form" method="POST"
                                                ...
                                                <input type="hidden" name="special_instruct"
                                                    class="customer_special_instruct">
                                                <input type="hidden" name="wts_number" class="customer_wts_number">
                                                <button type="submit" id="owner-coingate"
                                                    class="btn telegram-btn  pt-2" width="50px">
                                                    <i class="fas fa-credit-card"></i>
                                                    {{ __('Pay via CoinGate') }}
                                                </button>
                    ...
                    <div class="row" id="footer">
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <p class="text-store {{ env('SITE_RTL') == 'on' ? 'text-center' : 'text-left' }}">
                                {{ $store->footer_note }}</p>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <ul
                                class="nav mt-3 mt-md-0  {{ env('SITE_RTL') == 'on' ? 'm-auto float-left' : 'float-right text-left' }}">
                                ...
                                @if (!empty($store->whatsapp))
                                    <li class="nav-item">
                                        <a class="nav-link" href="https://wa.me/{{ $store->whatsapp }}"
                                            target=”_blank”>
            ...
            <div class="modal-content ">
                ...
                <div class="modal-body row">
                    ...
                    <div class="form-group col-6 d-flex justify-content-center col-form-label mb-0 asGuest">
                        <a href="#footer"
                            class="btn btn-primary ms-2 rounded-pill">{{ __('Continue as guest') }}</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    // Add an instance of the card Element into the `card-element` <div>.
        ...
        <script>
                    ...
                    success: function(data) {
                        ...
                        $.each(data.shipping, function(key, value) {
                            ...
                            html +=
                                ...
                                '" class="shipping_label"> &nbsp' + value.name + '</label></div>';
                        });
            ...
            $(document).on('click', '.add_to_cart', function(e) {
                ...
                $.ajax({
                    type: "POST",
                    url: '{{ route('user.addToCart', [$store->slug, '__product_id']) }}'.replace(
                        '__product_id', id),
                    data: {
                        "_token": "{{ csrf_token() }}",
                    },
            ...
            $(".product_qty_input").on('blur', function(e) {
                ...
                setTimeout(function() {
                    ...
                    $.ajax({
                        url: '{{ route('user-product_qty.product_qty', [$store->slug, '__product_id', 'arrkeys']) }}'
