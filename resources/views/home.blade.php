                                ...
                                <div class="row align-items-center">
                                    <div class="col-xxl-12">
                                        ...
                                        <div class="dropdown quick-add-btn">
                                            <a class="btn btn-primary btn-sm btn-q-add dropdown-toggle"
                                                            ...
                                                            <td>
                                                                <div class="d-flex align-items-center">
                                                                    ...
                                                                    <img src="{{ asset(Storage::url('uploads/is_cover_image/' . $product->is_cover)) }}"
                                                                        ...
                                                                        <a href="{{ $logo1 . (isset($product->is_cover) && !empty($product->is_cover) ? $product->is_cover : 'is_cover_image.png') }}"
                                                                            target="_blank">
                                                                            <img alt="Image placeholder" alt="your image"
                                                                                src="{{ $logo1 . (isset($product->is_cover) && !empty($product->is_cover) ? $product->is_cover : 'is_cover_image.png') }}"
                                                                                class="wid-25" alt="images">
                                                                        </a>
                                                                    @else
